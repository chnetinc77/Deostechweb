    ...
    <footer className="relative overflow-hidden border-t border-border">
      ...
      <div className="mx-auto max-w-6xl px-5 py-14">
        <div className="flex flex-col gap-10 md:flex-row md:items-start md:justify-between">
          <div className="max-w-sm">
            ...
            <p className="mt-4 text-pretty leading-relaxed text-muted-foreground">
              Building Intelligent Apps for Tomorrow.
            </p>
          </div>
              ...
              {socials.map((s) => {
                ...
                return (
                  <a
                    ...
                    className="flex h-10 w-10 items-center justify-center rounded-xl glass text-muted-foreground transition-all hover:-translate-y-0.5 hover:text-foreground"
                  >
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-3 border-t border-border pt-6 text-sm text-muted-foreground sm:flex-row">
          <p>© {new Date().getFullYear()} Deos Tech. All rights reserved.</p>
          <Link
            href="/privacy"
